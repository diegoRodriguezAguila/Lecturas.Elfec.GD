...
public class DataImportationNotifier implements IDataImportationObserver {
	...
	public void showErrors(int titleStrId, int iconDrawableId,
		...
		if (errors.size() > 0) {
			notification.contentView.setImageViewResource(R.id.notification_img, R.drawable.error_import_from_server_n);
			notification.contentView.setTextViewText(R.id.lbl_notification_title,
					context.getString(titleStrId));
			notification.contentView.setTextViewText(R.id.lbl_notification_message,
