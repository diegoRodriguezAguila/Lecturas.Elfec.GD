...
public class TimerView extends LinearLayout {
	 ...
	 *
	 * @param context
	 *            the Context in which to inflate the View
	 */
	 ...
	 *            the Context in which to inflate the View
	 * @param attrs
	 *            attributes that define the text color
	 */
	public TimerView(Context context, AttributeSet attrs) {
		super(context, attrs);

		mAndroidClockMonoThin = TypefaceUtils.load(context.getAssets(),
				"fonts/AndroidClockMono-Thin.ttf");
		mOriginalHoursTypeface = TypefaceUtils.load(context.getAssets(),
	...
	protected void onFinishInflate() {
		...
		if (mHoursSeperator != null) {
			mHoursSeperator.setTypeface(mOriginalHoursTypeface);
			mHoursSeperator.updatePaddingForBoldDate();
		}
	}
