...
/**
 * Factory para la creaci�n de reglas, nuevas reglas a�adidas deben a�adirse en
 * el constructor est�tico
 * 
 * @author Diego
 *
 */
public class ValidationRulesFactory {
	...
	static {
		...
		registeredValidations.put("NotNullOrEmpty",
				NotNullOrEmptyValidationRule.class);
	...
	public static <T> ValidationsAndParams<T> createValidationRulesWithParams(
