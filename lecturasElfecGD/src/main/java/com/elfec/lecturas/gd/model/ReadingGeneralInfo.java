...
public class ReadingGeneralInfo extends Model implements Serializable {
     ...
     *
     * @param readingTaken La lectura tomada, es necesario haber llamado a
     *                     {@link #save()}, es decir que esté guardada en la base de
     *                     datos antes de asignarla caso contrario lanza excepción
     *                     {@link IllegalArgumentException}
     * @param status       {@link ReadingStatus#READ}, {@link ReadingStatus#IMPEDED} o
     ...
     *
     * @param status {@link ReadingStatus} estado de la lectura
     * @param route  {@link RouteAssignment} assignación de ruta
     * @return Lista de lecturas
     */
    public static List<ReadingGeneralInfo> getAllReadingsSorted(
        ...
        if (route != null && route.getRoute() != 0)
