...
public class SwipeDismissRecyclerViewTouchListener implements
	 ...
	 * {@link SwipeDismissRecyclerViewTouchListener} to inform its client about
	 * a successful dismissal of one or more list item positions.
	 */
	 ...
	 * {@link SwipeDismissRecyclerViewTouchListener} is paused during list view
	 * scrolling.</p>
	 *
	...
	public boolean onTouch(View view, MotionEvent motionEvent) {
		...
		case MotionEvent.ACTION_DOWN: {
			...
			if (mDownView != null) {
				...
				mDownPosition = mRecyclerView
						.getChildAdapterPosition(mDownView);
		...
		case MotionEvent.ACTION_CANCEL: {
			...
			if (mDownView != null && mSwiping) {
				// cancel
				ViewCompat.animate(mDownView).translationX(0).alpha(1)
