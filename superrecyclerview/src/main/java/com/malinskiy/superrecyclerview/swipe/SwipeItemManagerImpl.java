...
public class SwipeItemManagerImpl implements SwipeItemManagerInterface {
	...
	private void initialize(
			BaseSwipeAdapter.BaseSwipeableViewHolder targetViewHolder,
			int position) {
		...
		targetViewHolder.swipeLayout
				.addSwipeListener(targetViewHolder.swipeMemory);
		targetViewHolder.swipeLayout
				.addOnLayoutListener(targetViewHolder.onLayoutListener);
	}

	public void updateConvertView(
			BaseSwipeAdapter.BaseSwipeableViewHolder targetViewHolder,
			int position) {
		...
		((OnLayoutListener) targetViewHolder.onLayoutListener)
